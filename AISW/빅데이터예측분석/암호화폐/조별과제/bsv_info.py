...
plt.title("BSV Close 데이터 분포")
plt.savefig('data/model/02_BSV원본데이터분포.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('data/model/02_BSV원본데이터그래프.png', dpi=300, bbox_inches='tight')
# plt.show()
